...
function ColorPicker:Constructor(color, dimension)
    ...
    self.radioButtons["R"] = Utils.RadioButton(self.radioContainer, L:GetText("Red"), true);
    ...
    self.radioButtons["G"] = Utils.RadioButton(self.radioContainer, L:GetText("Green"), false);
    ...
    self.radioButtons["B"] = Utils.RadioButton(self.radioContainer, L:GetText("Blue"), false);
    ...
    self.radioButtons["S"] = Utils.RadioButton(self.radioContainer, L:GetText("Saturation"), false);
    ...
    self.radioButtons["V"] = Utils.RadioButton(self.radioContainer, L:GetText("Value"), false);
...
function ColorPicker:AddRecentColor(newColor)
    ...
    for r = 1, #recentColors, 1 do
        ...
        oldColor = Utils.Color(oldColor.A, oldColor.R, oldColor.G, oldColor.B);
...
function ColorPicker:HexChanged()
    ...
    if (R and G and B) then
        self.hex:SetBackColor(Utils.Color(1, 1, 1, 1));
        ...
        self.hex:SetBackColor(Utils.Color(1, 1, 0, 0));
    end
end
